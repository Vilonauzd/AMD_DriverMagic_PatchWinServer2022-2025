...
Version: 0.6a (2025-10-12)

Fix:
- Removed invalid "function ... | Out-Null" pipe causing ParserError.
- Main uses Ensure-WebView2-Strict directly. No duplicate function defs.
- v0.6 features retained: Edge path detection, health probe, access logging, strict WebView chain, centered 50% UI, wrapped log.
#>
